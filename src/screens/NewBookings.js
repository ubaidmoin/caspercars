...
import { View, Text, StyleSheet, KeyboardAvoidingView, Dimensions, ScrollView, Platform, TouchableOpacity, Image, Modal } from 'react-native';
import DateTimePicker from '@react-native-community/datetimepicker';

import { CustomPicker, Input, Button, CustomDatePicker } from '../components/common';
            ...
            <KeyboardAvoidingView behavior="position" style={styles.containerStyle}>
                <ScrollView contentContainerStyle={styles.scrollViewContentContainerStyle} >
                    ...
                    <View style={styles.cardStyle}>
                        ...
                        />
                        <CustomDatePicker
                            datetime={pickupDate ? pickupDate.toDateString() : 'Select Pickup Date'}
                            onChange={showDatepicker}
                        />
                        <CustomDatePicker
                            datetime={pickupDate ? pickupDate.toLocaleTimeString() : 'Select Pickup Time'}
